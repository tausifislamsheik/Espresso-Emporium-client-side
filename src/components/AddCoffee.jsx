        ...
        <form onSubmit={handleAddCoffee}>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                <fieldset className="fieldset">
                    ...
                    <input type="text" name="name" className="input w-full border-none" placeholder="Enter Coffee Name" />
                </fieldset>
                <fieldset className="fieldset">
                    <legend className="fieldset-legend">Quantity</legend>
                    <input type="text" name="quantity" className="input w-full border-none" placeholder="Enter Quantity" />
                </fieldset>
                <fieldset className="fieldset">
                    <legend className="fieldset-legend">Supplier</legend>
                    <input type="text" name="supplier" className="input w-full border-none" placeholder="Enter Supplier" />
                </fieldset>
                <fieldset className="fieldset">
                    <legend className="fieldset-legend">Price</legend>
                    <input type="text" name="price" className="input w-full border-none" placeholder="Enter Price" />
                </fieldset>
                <fieldset className="fieldset">
                    <legend className="fieldset-legend">Category</legend>
                    <input type="text" name="category" className="input w-full border-none" placeholder="Enter Category" />
                </fieldset>
                <fieldset className="fieldset">
                    <legend className="fieldset-legend">Photo</legend>
                    <input type="text" name="photo" className="input w-full border-none" placeholder="Enter Photo URL" />
                </fieldset>
            </div>
                 <fieldset className="fieldset">
                    <legend className="fieldset-legend">Details</legend>
                    <textarea type="text" name="details" rows="" cols="50" className="input w-full border-none h-10" placeholder="Enter Details" />
                </fieldset>
